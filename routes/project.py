...
from crud.project import get_project_from_db, create_project_in_db, delete_project_in_db, list_all_projects
...
async def list_projects_preview(db = Depends(get_db)):
    list_of_projects = list_all_projects(db)
